...
first_stderr=$("${RWX_CLI}" sandbox exec "${SCRIPT_DIR}/definitions/sandbox.yml" -- sh -c 'echo first' 2>&1 >/dev/null) || true
...
second_stderr=$("${RWX_CLI}" sandbox exec "${SCRIPT_DIR}/definitions/sandbox.yml" -- sh -c 'echo second' 2>&1 >/dev/null) || true
...
third_stderr=$("${RWX_CLI}" sandbox exec "${SCRIPT_DIR}/definitions/sandbox.yml" -- sh -c 'echo third' 2>&1 >/dev/null) || true

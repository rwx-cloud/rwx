...
type APIClient interface {
	...
	GetAllArtifactDownloadRequests(taskId string) (api.ArtifactDownloadsResult, error)
	GetAllArtifactDownloadRequestsByTaskKey(runID, taskKey string) (api.ArtifactDownloadsResult, error)
